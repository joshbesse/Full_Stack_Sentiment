...
grid_search = RandomizedSearchCV(estimator=model, param_distributions=param_grid, scoring='f1_weighted', n_jobs=1, cv=5, verbose=1, n_iter=30)
...
joblib.dump(best_model, './ML models/Logistic Regression/log_reg_model.pkl')
