...
dataset = Dataset.from_pandas(df[['clean_text', 'category']])

# split dataset into training and test sets
train_test_split = dataset.train_test_split(test_size=0.2, stratify_by_column='category', seed=3)
